...
const MessageArea = ({questions, dummyAns, profilePic, trips}) => {
        ...
        return <div key ={i}>
          ...
          <br/>
          {
            ...
            <div className='flex flex-row gap-6'>
              <MessageReply dummyAns = {dummyAns} questions = {questions} answer = {dummyAns[i]} profilePic = {profilePic} trips = {trips} />
            </div>
            : 
