function ModalLostAndFound({ subData }) {
  ...
  return (
    <div className="my-10 m-2 max-h-full overflow-auto relative">
      {/* Header Row */}
      <div className="sticky top-0 grid grid-cols-[20%_20%_40%_20%] bg-[#F2F2F2] text-center py-4 text-[#864E41] rounded-md shadow-lg z-10">
        <div>Name</div>
        <div>Floor</div>
        <div>Details</div>
        <div>Status</div>
      ...
      {/* Scrollable Content */}
      <div className="h-max overflow-hidden m-2">
        {items.length > 0 ? (
