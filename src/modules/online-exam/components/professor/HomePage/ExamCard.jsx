    ...
    <div className="border border-[#BEBEBE] rounded-xl p-[10px] xl:p-[20px] ">
      <div>
        ...
        <div className="flex flex-wrap gap-1 xl:gap-4 pt-[12px]">
          ...
          <button className="btn xl:px-[20px] xl:text-[16px] text-white bg-[#E98713] hover:bg-[#d2801b]" onClick={() => {navigate(`/exams/professor/overallScoring/${examId}`)}}>Scoring</button>
