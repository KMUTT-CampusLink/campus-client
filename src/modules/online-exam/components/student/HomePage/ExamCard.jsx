...
export default function ExamCard({examName, Id}) {
  ...
  return (
    <div className="border border-[#BEBEBE] rounded-xl p-[15px] xl:p-[20px] flex justify-between items-center">
      ...
      <button className="btn text-white bg-[#E98713] hover:bg-[#d2801b]" onClick={() => {
        navigate(`/exams/student/examPassword/${Id}`);
      }}><p>Entered Exam</p><FontAwesomeIcon icon={faArrowRight} className="text-[20px]"/></button>
    </div>
  );
}
