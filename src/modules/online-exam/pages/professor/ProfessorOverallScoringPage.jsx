...
//     try {
//       const response = await updateExamAnnouncement({
//         examId,
//         publish_score_status: true,
//       });
//       setIsAnnounced(true);
//       handleCloseModal();
//     } catch (error) {
...
//               disabled={isAnnounced} // Disable if already announced
//             >
...
export default function ProfessorOverallScoringPage() {
  ...
  const handleConfirmPublish = async () => {
    try {
      const newIsAnnounced = true; // Set the new state value
      setIsAnnounced(newIsAnnounced);
      console.log(newIsAnnounced); // This will log 'true' immediately
  
      // Pass the updated value directly to the API call
