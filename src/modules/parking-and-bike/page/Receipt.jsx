  ...
  return (
    <>
      ...
      <FontAwesomeIcon className="flex absolute mt-3 w-20 h-20 text-green-500" icon={faCircleCheck} />
        ...
        <div className="flex flex-col justify-center items-center absolute top-24">
          <br />
        ...
        <button className="bg-red-500 text-white px-12 py-2 rounded-lg hover:bg-red-600 transition absolute bottom-20">CONTINUE</button>
