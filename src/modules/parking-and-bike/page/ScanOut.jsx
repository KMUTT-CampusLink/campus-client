...
function ScanOut() {
    ...
    const checkout_time = new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false });
    ...
    useEffect(() => {
        if (reservation_id && QRCode && checkout_time) {
    ...
    }, [reservation_id && QRCode && checkout_time]);
